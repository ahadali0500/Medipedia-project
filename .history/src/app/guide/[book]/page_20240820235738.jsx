            ...
            <div className="container mw-1470">
              <div className="col col-lg-12 row">
                <div className="col-lg-6">
                  <Link href={`/guide/book-bunde/1`} className="courses-category-single-item text-center box-shadow">
                ...
                <div className="col-lg-6">
                  <Link href={`/guide/book-bunde/2`} className="courses-category-single-item text-center box-shadow">
                    <h3 style={{ cursor: 'pointer' }}>
                      Book Bundle 2
                    </h3>
                  </Link>
