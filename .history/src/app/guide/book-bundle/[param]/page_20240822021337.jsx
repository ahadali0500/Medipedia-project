...
export default async function Page({ params }) {
  const { applyForCode, loading, error } = useApplyForCode();
        ...
        {params.param == 1  ? (
          <>
            <p style={{ textAlign: 'center', backgroundColor: '#ecf2fc', color: '#19b2ee', padding: '4px' }}>
              ...
              To get all books code at once just pay {data.price} <span onClick={() => applyForCode(object.slug)} > Get All Code</span>
            </p>
            <br />
          </>
