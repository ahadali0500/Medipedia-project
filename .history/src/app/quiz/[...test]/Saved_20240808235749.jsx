...
export default function Saved(props) {
    ...
    const handleNext = () => {
        if (!shuuflephase) {
            if (props.data[index].setoptans !== undefined || props.data[index].setoptans == null) {
    ...
    const option = async (val, ans, curr) => {
        if (!shuuflephase) {
            ...
            props.data[index].setoptans !== undefined || props.data[index].setoptans = ans;
                ...
                <div className="col-lg-10 col-md-10 ps-0">
                    <div style={{ paddingTop: '21px', paddingBottom: '21px' }} className="sign-up-form">
                        ...
                        <div className="quiz-lay-thr mt-4">
                            <div>
                                {!shuuflephase ? (
                                    props.data[index].setoptans !== undefined || props.data[index].setoptans == null ? (
                                        <></>
                                    ) : (
                            ...
                            <>
                                ...
                                <div className="row">
                                    ...
                                    {props.data[index].op1 &&
                                        ...
                                        <div
                                            style={props.data[index].setoptans !== undefined || props.data[index].setoptans == "A" ? { backgroundColor: 'green', color: 'white' } : (props.data[index].sel_ans == "A" ? { backgroundColor: 'red', color: 'white' } : {})}
                                            onClick={props.data[index].setoptans !== undefined || props.data[index].setoptans == null ? () => option(props.data[index].op1, props.data[index].ans, "A") : undefined}
                                    ...
                                    {props.data[index].op2 &&
                                        ...
                                        <div
                                            style={props.data[index].setoptans !== undefined || props.data[index].setoptans == "B" ? { backgroundColor: 'green', color: 'white' } : (props.data[index].sel_ans == "B" ? { backgroundColor: 'red', color: 'white' } : {})}
                                            onClick={props.data[index].setoptans !== undefined || props.data[index].setoptans == null ? () => option(props.data[index].op2, props.data[index].ans, "B") : undefined}
                                            className="col-lg-6 col-md-12 mcq-opt">
                                    ...
                                    {props.data[index].op3 &&
                                        ...
                                        <div
                                            style={props.data[index].setoptans !== undefined || props.data[index].setoptans == "C" ? { backgroundColor: 'green', color: 'white' } : (props.data[index].sel_ans == "C" ? { backgroundColor: 'red', color: 'white' } : {})}
                                            onClick={props.data[index].setoptans !== undefined || props.data[index].setoptans == null ? () => option(props.data[index].op3, props.data[index].ans, "C") : undefined}
                                            className="col-lg-6 col-md-12 mcq-opt">
                                    ...
                                    {props.data[index].op4 &&
                                        ...
                                        <div
                                            style={props.data[index].setoptans !== undefined || props.data[index].setoptans == "D" ? { backgroundColor: 'green', color: 'white' } : (props.data[index].sel_ans == "D" ? { backgroundColor: 'red', color: 'white' } : {})}
                                            onClick={props.data[index].setoptans !== undefined || props.data[index].setoptans == null ? () => option(props.data[index].op4, props.data[index].ans, "D") : undefined}
                                            className="col-lg-6 col-md-12 mcq-opt">
                                    ...
                                    {props.data[index].op5 &&
                                        ...
                                        <div
                                            style={props.data[index].setoptans !== undefined || props.data[index].setoptans == "E" ? { backgroundColor: 'green', color: 'white' } : (props.data[index].sel_ans == "E" ? { backgroundColor: 'red', color: 'white' } : {})}
                                            onClick={props.data[index].setoptans !== undefined || props.data[index].setoptans == null ? () => option(props.data[index].op5, props.data[index].ans, "E") : undefined}
                                            className="col-lg-6 col-md-12 mcq-opt">
                                ...
                                {props.data[index].reason && props.data[index].setoptans !== undefined || props.data[index].setoptans != null &&
                                    <>
                                ...
                                <div className="quiz-lay-2 mt-4">
                                    <div>
                                        <button onClick={() => props.data[index].setoptans !== undefined || props.data[index].setoptans == null ? skip() : undefined} className="btn btn-primary btn-md">Skip ({skiparr.length})</button>
                                    </div>
                                    <div className="la">
